                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="box">
                                         ...
                                         <form class="form-horizontal" method="POST" action="<?=base_url()?>department/insert">
                                                <div class="panel-body">
                                            <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">Department  <span style="color: #ff0000">*</span></label>
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="">
                                                    <input name="Department" required="" type="text" placeholder="Department " class="form-control" value="">
                                                    <div class="error"></div>
                                                </div>                                            
                                            </div>
                                        </div>
