       ...
       <section class="content-header">
                ...
                <section class="content">
                    <div class="row">
                     ...
                     <form class="form-horizontal" method="POST" action="<?=base_url()?>transaction/insert">
                                                <div class="panel-body">
                                            <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">Transaction Type  <span style="color: #ff0000">*</span></label>
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="">
                                                    <input name="Transaction_Type" required="" type="text" placeholder="Transaction Type" class="form-control">
                                                    <div class="error"></div>
                                                </div>                                            
                                            </div>
                                        </div>
