                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <div class="box">
                                           ...
                                           <form class="form-horizontal" method="POST" action="<?=base_url()?>city/update">
            <input type="hidden" name="Id_Cat_City" value="<?= $edit->Id_Cat_City?>">
                                                <div class="panel-body">
                                            <div class="form-group">
                                            <label class="col-md-3 col-xs-12 control-label">City <span style="color: #ff0000">*</span></label>
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="">
                                                    <input name="City" value="<?= $edit->City?>" required="" type="text" placeholder="Zone" class="form-control" value="">
                                                    <div class="error"></div>
                                                </div>                                            
                                            </div>
                                        </div>
