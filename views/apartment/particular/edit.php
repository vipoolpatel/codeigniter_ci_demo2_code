...
<div class="content-wrapper">
        ...
        <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Particular   </li>
                    </ol>
                </section>
                <!-- Main content -->
                                    ...
                                    <div class="col-xs-12">
                                        <div class="box">
                                            <div class="box-header">
                                                <h3 class="box-title">Edit Particular</h3> </div>




                                              <form class="form-horizontal" method="POST" action="<?=base_url()?>particular/update">
                                                <input type="hidden" name="Id_Particular" value="<?= $edit->Id_Particular?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="">
                                                    <input name="Email" required="" placeholder="Email" value="<?= $edit->Email?>" type="text" class="form-control" value="">
                                                    <div class="error"></div>
                                                </div>                                            
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="">
                                                    <input name="Phone" value="<?= $edit->Phone?>" required="" placeholder="Phone" type="text" class="form-control" value="">
                                                    <div class="error"></div>
                                                </div>                                            
                                            </div>
                                        </div>
