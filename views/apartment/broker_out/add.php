...
<div class="content-wrapper">
   <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Add Broker Out  </li>
                    </ol>
                </section>
                <!-- Main content -->
                                    ...
                                    <div class="col-xs-12">
                                        <div class="box">
                                            <div class="box-header">
                                                <h3 class="box-title">Create Broker Out</h3>


                                            </div>
                                        <form class="form-horizontal" method="POST" action="<?=base_url()?>brokerout/insert">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="">
                                                    <input name="Pbx" type="text" placeholder="Pbx" class="form-control" value="">
                                                    <div class="error"></div>
                                                </div>                                            
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">                                            
                                                <div class="">
                                                    <input name="Company" required="" placeholder="Company" type="text" class="form-control" value="">
                                                    <div class="error"></div>
                                                </div>                                            
                                            </div>
                                        </div>
